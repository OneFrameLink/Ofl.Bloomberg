...
public class BloombergBackOfficeReaderCreditRiskOutFileStreamTests
{
    #region Read-only state

    private const string NotImplementedForThisFile = "Appropriate test values for this file are not available at this time.";

    private const string TooLarge = "This file is too large and should not be run as part of regular testing.";

    #endregion

    #region Tests

    [Fact(Skip = NotImplementedForThisFile)]
    public async Task Test_ReadStartOfFile_Async()
    {
        // Get the stream.
        using var stream = Resource.GetCreditRiskOutFileStream();
    ...
    public async Task Test_EnumerateDataSection_Async()
    {
        ...
        // The rows.
        Assert.Equal(6908544, items.Count);
    }
