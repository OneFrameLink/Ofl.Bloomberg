...
public class SpanParserTryParseIntegerRealInt64Tests
{
    #region Tests

    public static IEnumerable<object[]> Test_Parse_Valid_Input_Parameters() =>
        SpanParserTryParseIntegerRealExtensions
            .GetByteParserTryParseIntegerRealTestParameters<long>(long.MaxValue);
    ...
    )
    {
        ...
        // Parse.
        var actualResult = span.TryParseIntegerRealInt64(
            out long actualInteger
    ...
    )
    {
        ...
        // Parse.
        var result = span.TryParseIntegerRealInt64(
            out _
            , out _
